...
//                die;
                echo '  
                    <li class="img_wrapper">
                        ...
                        <span class="text_effect" alt="' . $value['release_title'] . '"><span style="float:left;text-align:left;margin-left:5px;margin-top:5px;font-size:16px;line-height: 13px;">' . $value['release_title'] . '</span></span>
